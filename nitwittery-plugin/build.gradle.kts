...
val pluginLibPath = rootProject.layout.projectDirectory
    .file("target/release/libnitwittery_plugin.so").asFile.absolutePath
...
// `papermc.loader.plugin.path.nitwittery` system property is set (i.e. for production drop-in
// distributions).
...
tasks.runServer {
    ...
    systemProperty("papermc.loader.plugin.path.nitwittery", pluginLibPath)
