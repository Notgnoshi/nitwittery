...
/**
 * Static dispatch target invoked from Rust via JNI to deliver tracing events to
 ...
 *
 * Rust level mapping: 0=ERROR, 1=WARN, 2=INFO, 3=DEBUG, 4=TRACE. Sub-INFO Rust
 * events (DEBUG, TRACE) are emitted at INFO so they survive Paper's appender
 * filtering.
 */
public final class RustTracingSubscriber {

    private static final Level[] JAVA_LEVELS = {Level.SEVERE, Level.WARNING, Level.INFO, Level.FINE,
            Level.FINER,};
